...
python exp_runner2.py --mode train --conf ./confs/womask-27.conf --case dtu_scan24 --gpu 0
python exp_runner_tst.py --mode train --conf ./confs/womask-tst.conf --case dtu_scan24 --gpu 2
```
...
python exp_runner.py --mode train --conf ./confs/wmask-00.conf --case dtu_scan65 --gpu 1
python exp_runner2.py --mode train --conf ./confs/wmask-00.conf --case dtu_scan65 --gpu 1
```
tensorboard --logdir=exp/dtu_scan65/wmask/logs
